...
RELEASED_CHAPTERS = {"00", "01", "02"}
SHELL_VERSION = "0.20.0"
...
<main class="wrap">
  <header class="dg-hero">
    ...
    <span class="dg-status"><i></i>Chapters 00 to 02 available &middot; 22 chapters in development</span>
  </header>
