...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M49`.
...
Define where AI may support an advisory engagement and what must be disclosed, reviewed, verified, and retained.

## Required learner work product

**AI-assisted consulting engagement protocol**
