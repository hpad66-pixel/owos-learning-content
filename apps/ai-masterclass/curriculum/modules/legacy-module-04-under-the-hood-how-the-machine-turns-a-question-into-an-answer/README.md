...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M04`.
...
Decide what evidence and human review are required before using a model response in utility work.
