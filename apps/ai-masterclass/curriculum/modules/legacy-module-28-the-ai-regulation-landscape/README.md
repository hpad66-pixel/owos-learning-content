...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M28`.
...
Determine which legal or policy questions require qualified review for a proposed utility use case.

## Required learner work product

**AI regulatory applicability map**
