...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M08`.
...
Decide whether extracted or interpreted media is adequate for reference, requires human verification, or must not be used.

## Required learner work product

**multimodal evidence intake checklist**
