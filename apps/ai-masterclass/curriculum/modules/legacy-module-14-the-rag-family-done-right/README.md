...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M14`.
...
Select and defend a retrieval pattern for one bounded utility question.
