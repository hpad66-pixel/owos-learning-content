...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M11`.
...
Separate a current planning issue from a speculative scenario and decide what action is justified now.

## Required learner work product

**future-claim evidence and action brief**
