...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M57`.
...
Decide whether a forecast or simulation is fit for the planning or operating question and what sensitivity and validation are required.

## Required learner work product

**forecast and hydraulic-model decision sheet**
