# M33: Prompt, Context, Tool Orchestration, and Token Maxing

## Purpose

This folder is the governed curriculum-scrub and staff-direction package for `legacy:M33`.
...
Decide which failure belongs to the prompt, the supplied context, the surrounding workflow, the source, or the human review design.

## Required learner work product

**governed prompt and context specification**
