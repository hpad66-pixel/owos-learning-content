...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M45`.
...
Choose one task that may receive bounded support and define the source, review, record, and escalation path.

## Required learner work product

**operator-administrator AI support card**
