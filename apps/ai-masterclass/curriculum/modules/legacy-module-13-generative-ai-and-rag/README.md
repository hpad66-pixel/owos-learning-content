...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M13`.
...
Choose between unsupported generation, source-grounded retrieval, a fixed workflow, or no AI for a utility question.

## Required learner work product

**retrieval-grounded answer contract**
