...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M02`.
...
Classify a proposed utility solution as rules, statistical learning, machine learning, deep learning, generative AI, or a combination before evaluating it.

## Required learner work product

**AI family and claim map**
