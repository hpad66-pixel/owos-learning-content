...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M36`.
...
Decide which statements are sourced facts, expert interpretations, Hardeep positions, scenarios, or unresolved questions before drafting.

## Required learner work product

**source-backed research and writing package**

## Authority and status

- Curriculum authority: `hpad66-pixel/owos-learning-content`
- Source file: `AI Master CLass/HTML/Module_36_Research_Writing_Voice.html`
- Source pages in the governed curriculum: 403 through 414
