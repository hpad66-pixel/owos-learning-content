...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M34`.
...
Determine whether a repeatable utility task should become a reusable skill and define how it will be tested and maintained.

## Required learner work product

**versioned utility skill specification**

## Authority and status

- Curriculum authority: `hpad66-pixel/owos-learning-content`
- Source file: `AI Master CLass/HTML/Module_34_Skills_That_Write_Your_Prompts.html`
- Source pages in the governed curriculum: 377 through 392
