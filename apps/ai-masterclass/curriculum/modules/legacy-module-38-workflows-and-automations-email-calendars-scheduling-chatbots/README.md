...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M38`.
...
Choose which steps may be automated, which require review, and how the workflow records failure and returns control to a person.

## Required learner work product

**governed automation workflow map**
