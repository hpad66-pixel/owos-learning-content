...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M61`.
...
Determine what evidence and relationships a decision-support twin needs before it can responsibly inform one utility choice.

## Required learner work product

**Decision Twin scope and evidence canvas**
