...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M15`.
...
Decide whether semantic similarity is useful for a task and what metadata, filters, or verification must accompany it.

## Required learner work product

**semantic retrieval test record**
