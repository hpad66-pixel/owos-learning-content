...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M58`.
...
Determine what an alert means, what uncertainty remains, and which person or agency decides the response.

## Required learner work product

**storm and overflow prediction response plan**
