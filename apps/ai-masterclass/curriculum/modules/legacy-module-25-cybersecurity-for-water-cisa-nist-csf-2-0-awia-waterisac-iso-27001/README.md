...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M25`.
...
Set the identity, access, network, data, monitoring, and response controls for a bounded utility use case.

## Required learner work product

**water AI cybersecurity threat and control map**
