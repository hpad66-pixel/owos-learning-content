...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M59`.
...
Decide which compliance tasks may receive AI support and which statements or submissions require named professional certification and legal review.

## Required learner work product

**compliance evidence and reporting control record**
