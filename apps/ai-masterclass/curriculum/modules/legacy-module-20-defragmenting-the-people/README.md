...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M20`.
...
Decide how to investigate a conflict between the official record and current field knowledge without discarding either.

## Required learner work product

**cross-role knowledge and handoff map**
