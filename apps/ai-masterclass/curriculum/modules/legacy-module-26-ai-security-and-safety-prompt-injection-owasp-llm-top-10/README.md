...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M26`.
...
Identify how an instruction or source could alter system behavior and choose prevention, detection, containment, or refusal controls.

## Required learner work product

**AI attack and recovery test log**

## Authority and status

- Curriculum authority: `hpad66-pixel/owos-learning-content`
- Source file: `AI Master CLass/HTML/Module_26_AI_Security_and_Safety.html`
- Source pages in the governed curriculum: 295 through 303
