...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M17`.
...
Choose the structure needed to organize terms, define meaning, or connect relationships for a One Water question.

## Required learner work product

**One Water concept and relationship map**
