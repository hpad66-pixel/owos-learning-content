...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M54`.
...
Determine whether an alert or pattern justifies investigation and what evidence must be checked before a field or capital action.

## Required learner work product

**leak and non-revenue-water opportunity and response card**
