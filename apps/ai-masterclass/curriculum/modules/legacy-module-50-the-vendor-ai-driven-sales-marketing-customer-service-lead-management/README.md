...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M50`.
...
Choose an AI-assisted commercial workflow and define the evidence, consent, disclosure, approval, records, and handoff it requires.

## Required learner work product

**utility-market AI commercial workflow and proof card**
