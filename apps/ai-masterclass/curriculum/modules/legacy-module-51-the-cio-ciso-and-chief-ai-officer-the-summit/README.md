...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M51`.
...
Assign decision rights, shared controls, operating ownership, architecture, assurance, and escalation for an enterprise AI portfolio.

## Required learner work product

**enterprise AI decision-rights and assurance charter**
