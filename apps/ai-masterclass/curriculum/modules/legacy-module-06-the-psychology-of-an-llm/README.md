...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M06`.
...
Choose how to frame, challenge, verify, or stop an AI conversation when agreement and confidence may be misleading.

## Required learner work product

**AI conversation risk and verification checklist**

## Authority and status

- Curriculum authority: `hpad66-pixel/owos-learning-content`
- Source file: `AI Master CLass/HTML/Module_06_Psychology_of_an_LLM.html`
- Source pages in the governed curriculum: 79 through 88
