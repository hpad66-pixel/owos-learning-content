...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M29`.
...
Determine which actions a public utility should take now, monitor, or route for legal and policy review.

## Required learner work product

**public-sector AI action register**
