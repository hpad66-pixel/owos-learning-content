...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M47`.
...
Approve, redesign, defer, or stop a proposed AI investment using a complete evidence and accountability record.

## Required learner work product

**executive AI decision brief**
