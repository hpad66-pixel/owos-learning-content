...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M30`.
...
Draft a policy rule that a real employee can apply to a real utility task and that a reviewer can test.

## Required learner work product

**AI and data policy operating kit**
