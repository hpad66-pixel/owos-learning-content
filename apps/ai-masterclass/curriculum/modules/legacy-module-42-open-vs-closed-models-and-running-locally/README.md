...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M42`.
...
Choose a model deployment pattern for a bounded task and defend its data, cost, capability, maintenance, and exit tradeoffs.

## Required learner work product

**model hosting and control decision record**
