...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M27`.
...
Determine whether information may be used in an AI task and what minimization, consent, contract, access, retention, or review is required.

## Required learner work product

**privacy and AI data-use record**

## Authority and status

- Curriculum authority: `hpad66-pixel/owos-learning-content`
- Source file: `AI Master CLass/HTML/Module_27_Data_Privacy_PII.html`
- Source pages in the governed curriculum: 304 through 314
