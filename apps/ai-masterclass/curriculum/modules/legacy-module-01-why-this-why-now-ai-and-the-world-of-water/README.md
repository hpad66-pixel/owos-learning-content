...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M01`.
...
Decide whether a proposed AI use belongs in learning, advisory support, or a human-controlled operational decision path.

## Required learner work product

**AI opportunity and accountability card**
