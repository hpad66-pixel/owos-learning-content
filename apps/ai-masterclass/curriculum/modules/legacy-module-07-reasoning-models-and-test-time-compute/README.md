...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M07`.
...
Select an appropriate answer mode and review path for a routine, analytical, or consequential utility task.

## Required learner work product

**task-to-reasoning selection card**
