...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M56`.
...
Determine whether an AI recommendation is suitable for observation, simulation, advisory review, or no operational use.

## Required learner work product

**treatment decision-support boundary and test plan**
