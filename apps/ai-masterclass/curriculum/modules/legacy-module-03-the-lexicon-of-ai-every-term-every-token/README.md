...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M03`.
...
Choose the precise term needed to describe a model, product, input, output, source, tool, or workflow in a utility conversation.

## Required learner work product

**One Water AI vocabulary field guide**
