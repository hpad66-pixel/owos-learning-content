...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M46`.
...
Decide whether a team is ready to test one use case and what management system will keep the test accountable.

## Required learner work product

**manager AI operating cadence**
