...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M62`.
...
Decide what environmental evidence an AI investment or procurement decision requires and what reduction options are credible.

## Required learner work product

**AI sustainability boundary and measurement plan**
