...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M35`.
...
Select the least complicated approach that can meet the task, quality, privacy, cost, maintenance, and authority requirements.

## Required learner work product

**AI adaptation architecture decision record**

## Authority and status

- Curriculum authority: `hpad66-pixel/owos-learning-content`
- Source file: `AI Master CLass/HTML/Module_35_FineTune_RAG_Prompt.html`
- Source pages in the governed curriculum: 393 through 402
