...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M05`.
...
Identify which model-development evidence a utility needs before accepting a performance or suitability claim.

## Required learner work product

**model lifecycle and provenance card**

## Authority and status

- Curriculum authority: `hpad66-pixel/owos-learning-content`
- Source file: `AI Master CLass/HTML/Module_05_How_a_Model_Is_Made.html`
- Source pages in the governed curriculum: 70 through 78
