...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M32`.
...
Select an approved assistant and operating mode for a bounded utility task, or decide that none is suitable.

## Required learner work product

**AI assistant comparison and use card**
