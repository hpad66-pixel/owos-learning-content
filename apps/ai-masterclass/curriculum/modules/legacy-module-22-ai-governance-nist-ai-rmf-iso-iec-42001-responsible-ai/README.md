...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M22`.
...
Choose the governance activities, owners, evidence, and review depth required for a bounded AI use case.

## Required learner work product

**AI governance profile and evidence map**

## Authority and status

- Curriculum authority: `hpad66-pixel/owos-learning-content`
- Source file: `AI Master CLass/HTML/Module_22_AI_Governance.html`
- Source pages in the governed curriculum: 252 through 261
