...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M39`.
...
Decide whether a no-code or low-code tool fits a bounded prototype and what controls are required before using real utility data.

## Required learner work product

**no-code prototype decision and test plan**
