...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M21`.
...
Assign accountable roles and controls for one data element that affects a consequential utility decision.

## Required learner work product

**data stewardship and decision charter**
