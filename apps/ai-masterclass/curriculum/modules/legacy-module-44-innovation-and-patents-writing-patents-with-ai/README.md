...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M44`.
...
Decide which invention work may use an approved AI tool and which material must remain sealed or go directly to qualified counsel.

## Required learner work product

**AI-assisted invention and patent work protocol**
