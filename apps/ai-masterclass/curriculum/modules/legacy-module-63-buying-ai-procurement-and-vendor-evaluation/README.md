...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M63`.
...
Recommend buy, build, partner, pilot, defer, or stop for one utility need and defend the contract controls.

## Required learner work product

**AI procurement scorecard and decision record**
