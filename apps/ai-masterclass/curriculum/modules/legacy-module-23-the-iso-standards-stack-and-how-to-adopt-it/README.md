...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M23`.
...
Build a staged standards-adoption path that names scope, owner, evidence, dependencies, and independent review.

## Required learner work product

**ISO adoption roadmap**
