...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M60`.
...
Determine which customer interaction may receive AI support and how the official record, privacy boundary, accessibility need, and human escalation are preserved.

## Required learner work product

**customer and community AI service boundary card**
