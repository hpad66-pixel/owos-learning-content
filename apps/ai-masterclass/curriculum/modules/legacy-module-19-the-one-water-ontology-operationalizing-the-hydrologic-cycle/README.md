...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M19`.
...
Identify which natural, physical, organizational, and information relationships must be represented for a cross-domain decision.

## Required learner work product

**One Water ontology scope map**
