...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M09`.
...
Identify which application components are required for a bounded utility task and which claims belong to the model versus the surrounding system.

## Required learner work product

**AI application architecture sheet**
