...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M55`.
...
Decide whether evidence supports monitor, inspect, maintain, plan, or escalate for one asset.

## Required learner work product

**condition-based maintenance decision record**
