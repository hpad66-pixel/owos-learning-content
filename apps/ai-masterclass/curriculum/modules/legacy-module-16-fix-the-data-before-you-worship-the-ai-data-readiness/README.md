...
This folder is the governed curriculum-scrub and staff-direction package for `legacy:M16`.
...
Determine whether a utility problem is ready for AI, requires data and process repair, or should stop.

## Required learner work product

**One Water data-readiness diagnosis**

## Authority and status

- Curriculum authority: `hpad66-pixel/owos-learning-content`
- Source file: `AI Master CLass/HTML/Module_16_Fix_the_Data.html`
- Source pages in the governed curriculum: 176 through 186
