# Design Brief for M62: AI Sustainability: The Water & Energy Footprint of AI

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M62` |
| Curriculum part | AI Across the Water Lifecycle |
...
| Evidence boundary | Blueprint direction only. Date every footprint figure, show the calculation boundary, avoid false precision, and separate global research from a specific procurement or facility claim. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A sustainability claim cites one global estimate without naming the model, workload, data center, cooling system, grid, water source, location, or time period. |
| What must the learner decide before teaching begins? | Decide what environmental evidence an AI investment or procurement decision requires and what reduction options are credible. |
...
| What usable work product will the learner create? | AI sustainability boundary and measurement plan |
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: withdrawal, consumption, energy use, carbon intensity, embodied impact, workload, allocation, boundary, and uncertainty | quantity flow | AI resource-flow Sankey | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | true or false with correction |
| The module's consequential utility situation | structured explanation | system boundary diagram | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | ordering |
| The learner decision, evidence, and human authority | structured explanation | location-and-time comparison | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | evidence classification |
| The completed AI sustainability boundary and measurement plan | structured explanation | reduction option waterfall | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |

## Module design fingerprint

| Element | Selection |
| --- | --- |
| Narrative architecture | cross-role handoff to disagreement to resolution to operating contract |
| Mental model | A water audit is useful only when the system boundary and balance are clear. AI footprint claims need the same accounting discipline. |
| Purposeful interaction 1 | role-switch handoff, applied to: Decide what environmental evidence an AI investment or procurement decision requires and what reduction options are credible. |
| Purposeful interaction 2 | operating-contract builder, producing or reviewing the AI sustainability boundary and measurement plan |
| Visual types | AI resource-flow Sankey, system boundary diagram, location-and-time comparison, reduction option waterfall |
...
| Professional work product | AI sustainability boundary and measurement plan |
...
The **AI sustainability boundary and measurement plan** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **AI Sustainability: The Water & Energy Footprint of AI** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among withdrawal, consumption, energy use, carbon intensity, embodied impact, workload, allocation, boundary, and uncertainty?
...
7. What must be present in the **AI sustainability boundary and measurement plan** before it is reviewable?
...
- Previous module reviewed: M61.
- Next module reviewed: M63.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: AI resource-flow Sankey.
- Ordered visual-shape sequence: quantity flow, structured explanation, structured explanation, structured explanation.
- Interaction pair: role-switch handoff and operating-contract builder.
