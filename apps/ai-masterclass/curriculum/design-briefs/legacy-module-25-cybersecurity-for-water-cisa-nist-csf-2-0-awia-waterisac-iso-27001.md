# Design Brief for M25: Cybersecurity for Water: CISA, NIST CSF 2.0, AWIA, WaterISAC, ISO 27001

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M25` |
...
| Evidence boundary | Blueprint direction only. Use current United States primary authority and official guidance. Do not publish facility-sensitive architecture, credentials, vulnerabilities, or exploitable operating detail. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A vendor assistant needs documents and work-order data, but the proposed connection reaches farther into utility systems than the task requires. |
| What must the learner decide before teaching begins? | Set the identity, access, network, data, monitoring, and response controls for a bounded utility use case. |
...
| What usable work product will the learner create? | water AI cybersecurity threat and control map |
...
1. Explain Cybersecurity for Water: CISA, NIST CSF 2.0, AWIA, WaterISAC, ISO 27001 in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish asset, threat, vulnerability, consequence, identity, privilege, segmentation, monitoring, and response without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Use current United States primary authority and official guidance. Do not publish facility-sensitive architecture, credentials, vulnerabilities, or exploitable operating detail.
6. Create a usable water AI cybersecurity threat and control map with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: asset, threat, vulnerability, consequence, identity, privilege, segmentation, monitoring, and response | structured explanation | defense-in-depth layers | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | estimate and explain |
| The module's consequential utility situation | relationship | least-privilege access map | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | matching |
| The learner decision, evidence, and human authority | branching decision | threat path attack tree | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | decision multiple choice |
| The completed water AI cybersecurity threat and control map | role handoff | incident response swimlane | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A utility does not issue one master key because a contractor needs one room. Digital access should follow the same rule. |
| Purposeful interaction 1 | claim challenge, applied to: Set the identity, access, network, data, monitoring, and response controls for a bounded utility use case. |
| Purposeful interaction 2 | recommendation builder, producing or reviewing the water AI cybersecurity threat and control map |
| Visual types | defense-in-depth layers, least-privilege access map, threat path attack tree, incident response swimlane |
...
| Professional work product | water AI cybersecurity threat and control map |
...
The **water AI cybersecurity threat and control map** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Cybersecurity for Water: CISA, NIST CSF 2.0, AWIA, WaterISAC, ISO 27001** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among asset, threat, vulnerability, consequence, identity, privilege, segmentation, monitoring, and response?
...
7. What must be present in the **water AI cybersecurity threat and control map** before it is reviewable?
...
- Previous module reviewed: M24.
- Next module reviewed: M26.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: defense-in-depth layers.
- Ordered visual-shape sequence: structured explanation, relationship, branching decision, role handoff.
