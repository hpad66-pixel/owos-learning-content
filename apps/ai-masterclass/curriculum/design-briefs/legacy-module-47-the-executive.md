# Design Brief for M47: The Executive

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M47` |
| Curriculum part | Role-Based Practice |
...
| Evidence boundary | Blueprint direction only. Do not promise return, transformation, workforce benefit, compliance, or public trust. Require baselines, evidence, independent review, and staged decisions. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | Leadership sees a polished demonstration but cannot see the baseline, operating owner, source quality, full cost, security review, adoption burden, or stop condition. |
| What must the learner decide before teaching begins? | Approve, redesign, defer, or stop a proposed AI investment using a complete evidence and accountability record. |
...
| What usable work product will the learner create? | executive AI decision brief |
...
1. Explain The Executive in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish demonstration, pilot, capability, product, investment, operating model, public value, assurance, and decision right without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Do not promise return, transformation, workforce benefit, compliance, or public trust. Require baselines, evidence, independent review, and staged decisions.
6. Create a usable executive AI decision brief with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: demonstration, pilot, capability, product, investment, operating model, public value, assurance, and decision right | layered structure | executive decision stack | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | prediction and reveal |
| The module's consequential utility situation | comparison and tradeoff | value-risk-readiness matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | multi-select |
| The learner decision, evidence, and human authority | gated process | investment phase gates | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | scenario branching |
| The completed executive AI decision brief | relationship | operating-model network | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A capital request is not approved because the rendering looks good. Leadership expects need, options, cost, risk, ownership, and evidence. AI should face the same test. |
| Purposeful interaction 1 | tradeoff calculator, applied to: Approve, redesign, defer, or stop a proposed AI investment using a complete evidence and accountability record. |
| Purposeful interaction 2 | roadmap builder, producing or reviewing the executive AI decision brief |
| Visual types | executive decision stack, value-risk-readiness matrix, investment phase gates, operating-model network |
...
| Professional work product | executive AI decision brief |
...
The **executive AI decision brief** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **The Executive** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among demonstration, pilot, capability, product, investment, operating model, public value, assurance, and decision right?
...
7. What must be present in the **executive AI decision brief** before it is reviewable?
...
- Previous module reviewed: M46.
- Next module reviewed: M48.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: executive decision stack.
- Ordered visual-shape sequence: layered structure, comparison and tradeoff, gated process, relationship.
