# Design Brief for M45: The Operator and Administrator

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M45` |
...
| Evidence boundary | Blueprint direction only. Do not position AI as an operator, certified decision-maker, records officer, or replacement for local procedures and qualifications. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | An operator needs the current procedure during a night shift while an administrator must ensure the resulting note enters the correct official record. |
| What must the learner decide before teaching begins? | Choose one task that may receive bounded support and define the source, review, record, and escalation path. |
...
| What usable work product will the learner create? | operator-administrator AI support card |
...
1. Explain The Operator and Administrator in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish operating observation, advisory support, official record, draft, approval, shift handoff, and qualified authority without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Do not position AI as an operator, certified decision-maker, records officer, or replacement for local procedures and qualifications.
6. Create a usable operator-administrator AI support card with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: operating observation, advisory support, official record, draft, approval, shift handoff, and qualified authority | role handoff | shift handoff swimlane | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | estimate and explain |
| The module's consequential utility situation | relationship | operator evidence network | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | matching |
| The learner decision, evidence, and human authority | gated process | draft-to-record phase gates | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | decision multiple choice |
| The completed operator-administrator AI support card | comparison and tradeoff | support-versus-authority matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A good relief worker makes the next shift stronger by leaving a clear handoff. AI support should improve the handoff without becoming the operator. |
| Purposeful interaction 1 | consequence simulator, applied to: Choose one task that may receive bounded support and define the source, review, record, and escalation path. |
| Purposeful interaction 2 | control-plan builder, producing or reviewing the operator-administrator AI support card |
| Visual types | shift handoff swimlane, operator evidence network, draft-to-record phase gates, support-versus-authority matrix |
...
| Professional work product | operator-administrator AI support card |
...
The **operator-administrator AI support card** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **The Operator and Administrator** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among operating observation, advisory support, official record, draft, approval, shift handoff, and qualified authority?
...
7. What must be present in the **operator-administrator AI support card** before it is reviewable?
...
- Previous module reviewed: M44.
- Next module reviewed: M46.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: shift handoff swimlane.
- Ordered visual-shape sequence: role handoff, relationship, gated process, comparison and tradeoff.
