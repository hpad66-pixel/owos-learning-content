# Design Brief for M28: The AI Regulation Landscape

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M28` |
...
| Evidence boundary | Blueprint direction only. Use current United States primary authority for governing claims. Label proposed, stayed, repealed, superseded, voluntary, and jurisdiction-specific material accurately. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A vendor says its product is compliant with AI law, but the statement does not name the jurisdiction, provision, role, system use, or effective date. |
| What must the learner decide before teaching begins? | Determine which legal or policy questions require qualified review for a proposed utility use case. |
...
| What usable work product will the learner create? | AI regulatory applicability map |
...
1. Explain The AI Regulation Landscape in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish law, regulation, executive action, guidance, standard, proposal, effective date, and applicability without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Use current United States primary authority for governing claims. Label proposed, stayed, repealed, superseded, voluntary, and jurisdiction-specific material accurately.
6. Create a usable AI regulatory applicability map with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: law, regulation, executive action, guidance, standard, proposal, effective date, and applicability | comparison and tradeoff | regulatory applicability matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | question flip cards |
| The module's consequential utility situation | structured explanation | authority hierarchy | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | classify and retry |
| The learner decision, evidence, and human authority | change over time | effective-date timeline | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | scenario multiple choice |
| The completed AI regulatory applicability map | branching decision | use-case review decision tree | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A permit matrix shows which requirement applies to which activity and date. Regulation needs the same disciplined mapping. |
| Purposeful interaction 1 | failure injection, applied to: Determine which legal or policy questions require qualified review for a proposed utility use case. |
| Purposeful interaction 2 | recovery and artifact builder, producing or reviewing the AI regulatory applicability map |
| Visual types | regulatory applicability matrix, authority hierarchy, effective-date timeline, use-case review decision tree |
...
| Professional work product | AI regulatory applicability map |
...
The **AI regulatory applicability map** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **The AI Regulation Landscape** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among law, regulation, executive action, guidance, standard, proposal, effective date, and applicability?
...
7. What must be present in the **AI regulatory applicability map** before it is reviewable?
...
- Previous module reviewed: M27.
- Next module reviewed: M29.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: regulatory applicability matrix.
- Ordered visual-shape sequence: comparison and tradeoff, structured explanation, change over time, branching decision.
