# Design Brief for M14: The RAG Family, Done Right

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M14` |
...
| Evidence boundary | Blueprint direction only. Do not rank retrieval patterns as universally best. Evaluation must use the utility's documents, questions, permissions, and failure costs. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | One search works for a short procedure but fails on a long engineering specification with tables, appendices, revisions, and linked drawings. |
| What must the learner decide before teaching begins? | Select and defend a retrieval pattern for one bounded utility question. |
...
| What usable work product will the learner create? | retrieval architecture decision record |
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: keyword, vector, hybrid, metadata-filtered, graph-assisted, hierarchical, and agentic retrieval | branching decision | retrieval family decision tree | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | true or false with correction |
| The module's consequential utility situation | structured explanation | document chunk hierarchy | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | ordering |
| The learner decision, evidence, and human authority | structured explanation | hybrid search comparison | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | evidence classification |
| The completed retrieval architecture decision record | relationship | question-to-source routing map | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A reference desk does not use the same search method for a street address, a legal citation, and a history question. Retrieval needs the same fit to purpose. |
| Purposeful interaction 1 | role-switch handoff, applied to: Select and defend a retrieval pattern for one bounded utility question. |
| Purposeful interaction 2 | operating-contract builder, producing or reviewing the retrieval architecture decision record |
| Visual types | retrieval family decision tree, document chunk hierarchy, hybrid search comparison, question-to-source routing map |
...
| Professional work product | retrieval architecture decision record |
...
The **retrieval architecture decision record** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **The RAG Family, Done Right** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among keyword, vector, hybrid, metadata-filtered, graph-assisted, hierarchical, and agentic retrieval?
...
7. What must be present in the **retrieval architecture decision record** before it is reviewable?
...
- Previous module reviewed: M13.
- Next module reviewed: M15.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: retrieval family decision tree.
- Ordered visual-shape sequence: branching decision, structured explanation, structured explanation, relationship.
