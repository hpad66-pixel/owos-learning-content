# Design Brief for M05: How a Model Is Actually Made

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M05` |
...
| Evidence boundary | Blueprint direction only. Do not infer training data, model architecture, labor practices, or performance from vendor marketing. Mark proprietary and unknown details honestly. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A supplier reports a strong benchmark score, but the utility cannot see the training boundary, evaluation population, adaptation method, or operating conditions. |
| What must the learner decide before teaching begins? | Identify which model-development evidence a utility needs before accepting a performance or suitability claim. |
...
| What usable work product will the learner create? | model lifecycle and provenance card |
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: data preparation, pretraining, fine-tuning, alignment, evaluation, deployment, and monitoring | gated process | model lifecycle phase gates | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | estimate and explain |
| The module's consequential utility situation | filtering | training data funnel | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | matching |
| The learner decision, evidence, and human authority | structured explanation | evaluation split diagram | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | decision multiple choice |
| The completed model lifecycle and provenance card | feedback cycle | deployment monitoring loop | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | Hiring someone, training them, testing them, assigning a job, and supervising their work are different steps. Model development also needs those steps kept separate. |
| Purposeful interaction 1 | consequence simulator, applied to: Identify which model-development evidence a utility needs before accepting a performance or suitability claim. |
| Purposeful interaction 2 | control-plan builder, producing or reviewing the model lifecycle and provenance card |
| Visual types | model lifecycle phase gates, training data funnel, evaluation split diagram, deployment monitoring loop |
...
| Professional work product | model lifecycle and provenance card |
...
The **model lifecycle and provenance card** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **How a Model Is Actually Made** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among data preparation, pretraining, fine-tuning, alignment, evaluation, deployment, and monitoring?
...
7. What must be present in the **model lifecycle and provenance card** before it is reviewable?
...
- Previous module reviewed: M04.
- Next module reviewed: M06.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: model lifecycle phase gates.
- Ordered visual-shape sequence: gated process, filtering, structured explanation, feedback cycle.
