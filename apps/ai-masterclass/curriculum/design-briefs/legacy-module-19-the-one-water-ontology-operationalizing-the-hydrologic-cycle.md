# Design Brief for M19: The One Water Ontology: Operationalizing the Hydrologic Cycle

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M19` |
| Curriculum part | Retrieval, Generation and the Data Foundation |
...
| Evidence boundary | Blueprint direction only. Do not flatten drinking water, wastewater, stormwater, reuse, watershed, and public-health authority into one generic process. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A rainfall event becomes runoff, inflow, treatment load, receiving-water impact, customer concern, operating response, and capital question across disconnected systems. |
| What must the learner decide before teaching begins? | Identify which natural, physical, organizational, and information relationships must be represented for a cross-domain decision. |
...
| What usable work product will the learner create? | One Water ontology scope map |
...
1. Explain The One Water Ontology: Operationalizing the Hydrologic Cycle in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish hydrologic connection, service domain, asset, event, observation, responsibility, consequence, and shared identity without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Do not flatten drinking water, wastewater, stormwater, reuse, watershed, and public-health authority into one generic process.
6. Create a usable One Water ontology scope map with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: hydrologic connection, service domain, asset, event, observation, responsibility, consequence, and shared identity | relationship | storm-to-bay systems map | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | prediction and reveal |
| The module's consequential utility situation | layered structure | natural-physical-people stack | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | multi-select |
| The learner decision, evidence, and human authority | structured explanation | cross-domain event trace | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | scenario branching |
| The completed One Water ontology scope map | relationship | One Water responsibility network | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A passport preserves one identity while recording movement across borders. A One Water model should connect movement without erasing each domain's rules. |
| Purposeful interaction 1 | option comparator, applied to: Identify which natural, physical, organizational, and information relationships must be represented for a cross-domain decision. |
| Purposeful interaction 2 | decision-record builder, producing or reviewing the One Water ontology scope map |
| Visual types | storm-to-bay systems map, natural-physical-people stack, cross-domain event trace, One Water responsibility network |
...
| Professional work product | One Water ontology scope map |
...
The **One Water ontology scope map** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **The One Water Ontology: Operationalizing the Hydrologic Cycle** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among hydrologic connection, service domain, asset, event, observation, responsibility, consequence, and shared identity?
...
7. What must be present in the **One Water ontology scope map** before it is reviewable?
...
- Previous module reviewed: M18.
- Next module reviewed: M20.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: storm-to-bay systems map.
- Ordered visual-shape sequence: relationship, layered structure, structured explanation, relationship.
