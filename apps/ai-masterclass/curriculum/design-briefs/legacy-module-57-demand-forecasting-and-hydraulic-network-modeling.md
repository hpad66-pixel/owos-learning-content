# Design Brief for M57: Demand Forecasting and Hydraulic/Network Modeling

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M57` |
...
| Evidence boundary | Blueprint direction only. Do not treat model output as observed fact or hide uncertainty behind a single line. Preserve engineering ownership and approved model assumptions. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A demand forecast looks precise but depends on weather, growth, customer behavior, meter coverage, and a calibration period that may not represent the decision horizon. |
| What must the learner decide before teaching begins? | Decide whether a forecast or simulation is fit for the planning or operating question and what sensitivity and validation are required. |
...
| What usable work product will the learner create? | forecast and hydraulic-model decision sheet |
...
1. Explain Demand Forecasting and Hydraulic/Network Modeling in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish forecast, simulation, model, calibration, validation, scenario, sensitivity, uncertainty, and decision horizon without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Do not treat model output as observed fact or hide uncertainty behind a single line. Preserve engineering ownership and approved model assumptions.
6. Create a usable forecast and hydraulic-model decision sheet with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: forecast, simulation, model, calibration, validation, scenario, sensitivity, uncertainty, and decision horizon | structured explanation | forecast uncertainty fan | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | estimate and explain |
| The module's consequential utility situation | relationship | network model map | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | matching |
| The learner decision, evidence, and human authority | structured explanation | calibration before-and-after | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | decision multiple choice |
| The completed forecast and hydraulic-model decision sheet | structured explanation | scenario sensitivity tornado | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |

## Module design fingerprint

| Element | Selection |
| --- | --- |
| Narrative architecture | public question to claim challenge to scenario comparison to recommendation |
| Mental model | A map can guide a trip only when the scale, date, and road assumptions fit the route. Models also depend on fit to purpose. |
| Purposeful interaction 1 | claim challenge, applied to: Decide whether a forecast or simulation is fit for the planning or operating question and what sensitivity and validation are required. |
| Purposeful interaction 2 | recommendation builder, producing or reviewing the forecast and hydraulic-model decision sheet |
| Visual types | forecast uncertainty fan, network model map, calibration before-and-after, scenario sensitivity tornado |
...
| Professional work product | forecast and hydraulic-model decision sheet |
...
The **forecast and hydraulic-model decision sheet** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Demand Forecasting and Hydraulic/Network Modeling** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among forecast, simulation, model, calibration, validation, scenario, sensitivity, uncertainty, and decision horizon?
...
7. What must be present in the **forecast and hydraulic-model decision sheet** before it is reviewable?
...
- Previous module reviewed: M56.
- Next module reviewed: M58.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: forecast uncertainty fan.
- Ordered visual-shape sequence: structured explanation, relationship, structured explanation, structured explanation.
- Interaction pair: claim challenge and recommendation builder.
