...
| Evidence boundary | Blueprint direction only. Never imply that AI may operate treatment, distribution, collection, flood-control, or safety systems without approved deterministic controls and qualified human authority. |
...
| What must the learner decide before teaching begins? | Set the narrowest useful level of automation and name every human checkpoint, prohibited action, and stop condition. |
...
| What usable work product will the learner create? | autonomy and human-authority matrix |
...
2. Distinguish assistance, augmentation, workflow automation, bounded agency, autonomous action, approval, and operating authority without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Never imply that AI may operate treatment, distribution, collection, flood-control, or safety systems without approved deterministic controls and qualified human authority.
6. Create a usable autonomy and human-authority matrix with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: assistance, augmentation, workflow automation, bounded agency, autonomous action, approval, and operating authority | range | autonomy spectrum | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | true or false with correction |
| The module's consequential utility situation | role handoff | human checkpoint swimlane | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | ordering |
| The learner decision, evidence, and human authority | comparison and tradeoff | reversibility-consequence matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | evidence classification |
| The completed autonomy and human-authority matrix | branching decision | stop-condition decision tree | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Purposeful interaction 1 | provenance tracer, applied to: Set the narrowest useful level of automation and name every human checkpoint, prohibited action, and stop condition. |
| Purposeful interaction 2 | stewardship-record builder, producing or reviewing the autonomy and human-authority matrix |
| Visual types | autonomy spectrum, human checkpoint swimlane, reversibility-consequence matrix, stop-condition decision tree |
...
| Professional work product | autonomy and human-authority matrix |
...
The **autonomy and human-authority matrix** must record the problem, user, decision, approved evidence, assumptions,
...
3. What is the difference among assistance, augmentation, workflow automation, bounded agency, autonomous action, approval, and operating authority?
...
7. What must be present in the **autonomy and human-authority matrix** before it is reviewable?
...
- Dominant visual: autonomy spectrum.
- Ordered visual-shape sequence: range, role handoff, comparison and tradeoff, branching decision.
