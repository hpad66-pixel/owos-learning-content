# Design Brief for M02: What AI Actually Is: From 1956 to Today

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M02` |
...
| Evidence boundary | Blueprint direction only. Use dated primary histories and technical sources. Do not present one clean timeline as if research developed in a single straight line. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A utility receives three proposals that all say AI, even though one is a rules engine, one is a forecasting model, and one is a generative assistant. |
| What must the learner decide before teaching begins? | Classify a proposed utility solution as rules, statistical learning, machine learning, deep learning, generative AI, or a combination before evaluating it. |
...
| What usable work product will the learner create? | AI family and claim map |
...
1. Explain What AI Actually Is: From 1956 to Today in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish rules, expert systems, statistical learning, machine learning, deep learning, and generative models without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Use dated primary histories and technical sources. Do not present one clean timeline as if research developed in a single straight line.
6. Create a usable AI family and claim map with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: rules, expert systems, statistical learning, machine learning, deep learning, and generative models | branching decision | AI family tree | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | true or false with correction |
| The module's consequential utility situation | change over time | capability timeline | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | ordering |
| The learner decision, evidence, and human authority | structured explanation | rules-to-learning comparison | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | evidence classification |
| The completed AI family and claim map | structured explanation | utility proposal classifier | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A family tree helps you see shared ancestry without pretending every relative has the same job. AI history works the same way. |
| Purposeful interaction 1 | provenance tracer, applied to: Classify a proposed utility solution as rules, statistical learning, machine learning, deep learning, generative AI, or a combination before evaluating it. |
| Purposeful interaction 2 | stewardship-record builder, producing or reviewing the AI family and claim map |
| Visual types | AI family tree, capability timeline, rules-to-learning comparison, utility proposal classifier |
...
| Professional work product | AI family and claim map |
...
The **AI family and claim map** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **What AI Actually Is: From 1956 to Today** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among rules, expert systems, statistical learning, machine learning, deep learning, and generative models?
...
7. What must be present in the **AI family and claim map** before it is reviewable?
...
- Previous module reviewed: M01.
- Next module reviewed: M03.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: AI family tree.
- Ordered visual-shape sequence: branching decision, change over time, structured explanation, structured explanation.
