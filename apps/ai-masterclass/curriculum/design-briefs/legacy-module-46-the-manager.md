# Design Brief for M46: The Manager

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M46` |
...
| Evidence boundary | Blueprint direction only. Do not make staff evaluation, productivity, discipline, or workforce claims from unvalidated AI metrics or private learning data. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A manager has several enthusiastic experiments but no shared priorities, time allocation, review standard, issue route, or decision about what stops. |
| What must the learner decide before teaching begins? | Decide whether a team is ready to test one use case and what management system will keep the test accountable. |
...
| What usable work product will the learner create? | manager AI operating cadence |
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: idea, experiment, pilot, product, owner, reviewer, measure, issue, escalation, and stop decision | feedback cycle | management operating loop | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | true or false with correction |
| The module's consequential utility situation | comparison and tradeoff | use-case priority matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | ordering |
| The learner decision, evidence, and human authority | structured explanation | role and review RACI | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | evidence classification |
| The completed manager AI operating cadence | status and measure | pilot status scorecard | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A weekly operating meeting works when actions have owners, dates, evidence, and decisions. AI work needs the same rhythm. |
| Purposeful interaction 1 | role-switch handoff, applied to: Decide whether a team is ready to test one use case and what management system will keep the test accountable. |
| Purposeful interaction 2 | operating-contract builder, producing or reviewing the manager AI operating cadence |
| Visual types | management operating loop, use-case priority matrix, role and review RACI, pilot status scorecard |
...
| Professional work product | manager AI operating cadence |
...
The **manager AI operating cadence** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **The Manager** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among idea, experiment, pilot, product, owner, reviewer, measure, issue, escalation, and stop decision?
...
7. What must be present in the **manager AI operating cadence** before it is reviewable?
...
- Previous module reviewed: M45.
- Next module reviewed: M47.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: management operating loop.
- Ordered visual-shape sequence: feedback cycle, comparison and tradeoff, structured explanation, status and measure.
