# Design Brief for M12: Jobs, Money, and the Utility

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M12` |
...
| Evidence boundary | Blueprint direction only. Do not promise staff reductions, productivity, return, ratepayer savings, service improvement, risk reduction, or public value without an approved baseline, complete cost, measured evidence, and accountable benefit owner. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A budget proposal counts model fees and staff hours saved but ignores data cleanup, review, integration, training, support, error recovery, and work that shifts to another team. |
| What must the learner decide before teaching begins? | Decide which tasks should change, what new work appears, which measures establish value, who owns each benefit, and when the evidence requires redesign or stop. |
...
| What usable work product will the learner create? | utility AI value and benefit-realization record |
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: job, task, output, activity, adoption, quality, service outcome, risk reduction, direct cost, shifted cost, public value, financial value, and realized benefit | cause and evidence sequence | baseline-to-benefit chain | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | question flip cards |
| The module's consequential utility situation | structured explanation | total-cost and shifted-work iceberg | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | classify and retry |
| The learner decision, evidence, and human authority | structured explanation | measure hierarchy | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | scenario multiple choice |
| The completed utility AI value and benefit-realization record | gated process | continue-redesign-stop phase gates | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A household budget does not improve because one bill moved to another column. AI value must count the complete flow of work and money. |
| Purposeful interaction 1 | failure injection, applied to: Decide which tasks should change, what new work appears, which measures establish value, who owns each benefit, and when the evidence requires redesign or stop. |
| Purposeful interaction 2 | recovery and artifact builder, producing or reviewing the utility AI value and benefit-realization record |
| Visual types | baseline-to-benefit chain, total-cost and shifted-work iceberg, measure hierarchy, continue-redesign-stop phase gates |
...
| Professional work product | utility AI value and benefit-realization record |
...
The **utility AI value and benefit-realization record** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Jobs, Money, and the Utility** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among job, task, output, activity, adoption, quality, service outcome, risk reduction, direct cost, shifted cost, public value, financial value, and realized benefit?
...
7. What must be present in the **utility AI value and benefit-realization record** before it is reviewable?
...
- Previous module reviewed: M11.
- Next module reviewed: M13.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: baseline-to-benefit chain.
- Ordered visual-shape sequence: cause and evidence sequence, structured explanation, structured explanation, gated process.
