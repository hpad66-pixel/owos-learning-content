# Design Brief for M06: The Psychology of an LLM

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M06` |
...
| Evidence boundary | Blueprint direction only. Do not diagnose a model as conscious, deceptive, emotional, or psychologically human. Separate observed output behavior from claims about inner state. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A manager asks a leading question, receives a polished answer that agrees, and mistakes agreement for independent confirmation. |
| What must the learner decide before teaching begins? | Choose how to frame, challenge, verify, or stop an AI conversation when agreement and confidence may be misleading. |
...
| What usable work product will the learner create? | AI conversation risk and verification checklist |
...
1. Explain The Psychology of an LLM in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish language behavior, apparent personality, agreement, confidence, intention, memory, and verified knowledge without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Do not diagnose a model as conscious, deceptive, emotional, or psychologically human. Separate observed output behavior from claims about inner state.
6. Create a usable AI conversation risk and verification checklist with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: language behavior, apparent personality, agreement, confidence, intention, memory, and verified knowledge | feedback cycle | framing-response loop | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | true or false with correction |
| The module's consequential utility situation | structured explanation | sycophancy comparison | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | ordering |
| The learner decision, evidence, and human authority | structured explanation | trust calibration gauge | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | evidence classification |
| The completed AI conversation risk and verification checklist | structured explanation | memory and context layers | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A mirror can reflect your posture with great detail. It cannot tell you whether your plan is sound. A language model can reflect framing in the same way. |
| Purposeful interaction 1 | role-switch handoff, applied to: Choose how to frame, challenge, verify, or stop an AI conversation when agreement and confidence may be misleading. |
| Purposeful interaction 2 | operating-contract builder, producing or reviewing the AI conversation risk and verification checklist |
| Visual types | framing-response loop, sycophancy comparison, trust calibration gauge, memory and context layers |
...
| Professional work product | AI conversation risk and verification checklist |
...
The **AI conversation risk and verification checklist** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **The Psychology of an LLM** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among language behavior, apparent personality, agreement, confidence, intention, memory, and verified knowledge?
...
7. What must be present in the **AI conversation risk and verification checklist** before it is reviewable?
...
- Previous module reviewed: M05.
- Next module reviewed: M07.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: framing-response loop.
- Ordered visual-shape sequence: feedback cycle, structured explanation, structured explanation, structured explanation.
