# Design Brief for M17: Life Is a Graph: Taxonomy, Ontology, Knowledge Graphs

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M17` |
...
| Evidence boundary | Blueprint direction only. Do not present a graph as automatically correct or complete. Meaning, identity, provenance, validation, and stewardship remain governed work. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | Operations, engineering, finance, and customer service use different names for the same asset and cannot trace which records describe it. |
| What must the learner decide before teaching begins? | Choose the structure needed to organize terms, define meaning, or connect relationships for a One Water question. |
...
| What usable work product will the learner create? | One Water concept and relationship map |
...
1. Explain Life Is a Graph: Taxonomy, Ontology, Knowledge Graphs in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish list, taxonomy, ontology, entity, relationship, property, rule, and knowledge graph without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Do not present a graph as automatically correct or complete. Meaning, identity, provenance, validation, and stewardship remain governed work.
6. Create a usable One Water concept and relationship map with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: list, taxonomy, ontology, entity, relationship, property, rule, and knowledge graph | branching decision | tree-to-web transformation | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | estimate and explain |
| The module's consequential utility situation | relationship | One Water relationship network | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | matching |
| The learner decision, evidence, and human authority | structured explanation | entity identity resolver | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | decision multiple choice |
| The completed One Water concept and relationship map | relationship | ontology validation map | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A tree gives each thing an address. A web shows how things affect one another. Utilities need both the address and the relationships. |
| Purposeful interaction 1 | claim challenge, applied to: Choose the structure needed to organize terms, define meaning, or connect relationships for a One Water question. |
| Purposeful interaction 2 | recommendation builder, producing or reviewing the One Water concept and relationship map |
| Visual types | tree-to-web transformation, One Water relationship network, entity identity resolver, ontology validation map |
...
| Professional work product | One Water concept and relationship map |
...
The **One Water concept and relationship map** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Life Is a Graph: Taxonomy, Ontology, Knowledge Graphs** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among list, taxonomy, ontology, entity, relationship, property, rule, and knowledge graph?
...
7. What must be present in the **One Water concept and relationship map** before it is reviewable?
...
- Previous module reviewed: M16.
- Next module reviewed: M18.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: tree-to-web transformation.
- Ordered visual-shape sequence: branching decision, relationship, structured explanation, relationship.
