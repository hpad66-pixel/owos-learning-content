# Design Brief for M38: Workflows and Automations: Email, Calendars, Scheduling, Chatbots

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M38` |
...
| Evidence boundary | Blueprint direction only. Do not connect live email, calendars, customer systems, or records without approved identity, permissions, testing, logging, privacy, and rollback. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | An email-triggered automation creates a meeting, sends a customer message, and updates a record before anyone notices that the original request was misclassified. |
| What must the learner decide before teaching begins? | Choose which steps may be automated, which require review, and how the workflow records failure and returns control to a person. |
...
| What usable work product will the learner create? | governed automation workflow map |
...
1. Explain Workflows and Automations: Email, Calendars, Scheduling, Chatbots in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish trigger, condition, action, approval, state, record, exception, retry, escalation, and recovery without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Do not connect live email, calendars, customer systems, or records without approved identity, permissions, testing, logging, privacy, and rollback.
6. Create a usable governed automation workflow map with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: trigger, condition, action, approval, state, record, exception, retry, escalation, and recovery | role handoff | automation swimlane | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | true or false with correction |
| The module's consequential utility situation | branching decision | trigger-condition-action tree | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | ordering |
| The learner decision, evidence, and human authority | feedback cycle | exception and recovery loop | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | evidence classification |
| The completed governed automation workflow map | relationship | human checkpoint map | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | An assembly line works because every station, inspection, stop cord, and rejected item has a defined path. Digital workflows need the same discipline. |
| Purposeful interaction 1 | role-switch handoff, applied to: Choose which steps may be automated, which require review, and how the workflow records failure and returns control to a person. |
| Purposeful interaction 2 | operating-contract builder, producing or reviewing the governed automation workflow map |
| Visual types | automation swimlane, trigger-condition-action tree, exception and recovery loop, human checkpoint map |
...
| Professional work product | governed automation workflow map |
...
The **governed automation workflow map** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Workflows and Automations: Email, Calendars, Scheduling, Chatbots** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among trigger, condition, action, approval, state, record, exception, retry, escalation, and recovery?
...
7. What must be present in the **governed automation workflow map** before it is reviewable?
...
- Previous module reviewed: M37.
- Next module reviewed: M39.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: automation swimlane.
- Ordered visual-shape sequence: role handoff, branching decision, feedback cycle, relationship.
