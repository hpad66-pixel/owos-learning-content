# Design Brief for M27: Data Privacy, PII, and Where Your Data Goes

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M27` |
| Curriculum part | Governance, Security and Provenance |
...
| Evidence boundary | Blueprint direction only. Privacy requirements vary by data, organization, contract, and jurisdiction. Do not provide legal advice or assume product settings are identical across plans and dates. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | An employee pastes a customer complaint containing contact, health, billing, and location information into an unapproved assistant to draft a response. |
| What must the learner decide before teaching begins? | Determine whether information may be used in an AI task and what minimization, consent, contract, access, retention, or review is required. |
...
| What usable work product will the learner create? | privacy and AI data-use record |
...
1. Explain Data Privacy, PII, and Where Your Data Goes in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish personal information, sensitive information, purpose, consent, minimization, retention, training use, memory, and connector access without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Privacy requirements vary by data, organization, contract, and jurisdiction. Do not provide legal advice or assume product settings are identical across plans and dates.
6. Create a usable privacy and AI data-use record with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: personal information, sensitive information, purpose, consent, minimization, retention, training use, memory, and connector access | structured explanation | personal-data lifecycle | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | prediction and reveal |
| The module's consequential utility situation | comparison and tradeoff | purpose-and-permission matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | multi-select |
| The learner decision, evidence, and human authority | filtering | data minimization funnel | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | scenario branching |
| The completed privacy and AI data-use record | structured explanation | product data-flow comparison | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A sealed envelope protects information only while the chain of handling remains controlled. Copying the contents creates a new obligation. |
| Purposeful interaction 1 | option comparator, applied to: Determine whether information may be used in an AI task and what minimization, consent, contract, access, retention, or review is required. |
| Purposeful interaction 2 | decision-record builder, producing or reviewing the privacy and AI data-use record |
| Visual types | personal-data lifecycle, purpose-and-permission matrix, data minimization funnel, product data-flow comparison |
...
| Professional work product | privacy and AI data-use record |
...
The **privacy and AI data-use record** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Data Privacy, PII, and Where Your Data Goes** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among personal information, sensitive information, purpose, consent, minimization, retention, training use, memory, and connector access?
...
7. What must be present in the **privacy and AI data-use record** before it is reviewable?
...
- Previous module reviewed: M26.
- Next module reviewed: M28.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: personal-data lifecycle.
- Ordered visual-shape sequence: structured explanation, comparison and tradeoff, filtering, structured explanation.
