# Design Brief for M41: Agents, Agentic Nests, and Orchestration

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M41` |
...
| Evidence boundary | Blueprint direction only. Do not imply that multiple agents create independent truth or professional authority. Preserve sources, permissions, cost limits, and human decision rights. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | Three agents produce separate recommendations, but they use different source versions and no person owns disagreement or the final decision. |
| What must the learner decide before teaching begins? | Choose between a fixed workflow, one agent, or multiple specialists and define the handoff and escalation contract. |
...
| What usable work product will the learner create? | utility agent and orchestration canvas |
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: workflow, agent, specialist, orchestrator, shared state, handoff, evaluation, retry, escalation, and stop | feedback cycle | agent loop stepper | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | estimate and explain |
| The module's consequential utility situation | relationship | multi-agent handoff network | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | matching |
| The learner decision, evidence, and human authority | structured explanation | shared-state ledger | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | decision multiple choice |
| The completed utility agent and orchestration canvas | comparison and tradeoff | workflow-or-agent decision matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A staffed incident room works because roles, evidence, handoffs, command, and the decision log are explicit. More people without coordination create noise. |
| Purposeful interaction 1 | claim challenge, applied to: Choose between a fixed workflow, one agent, or multiple specialists and define the handoff and escalation contract. |
| Purposeful interaction 2 | recommendation builder, producing or reviewing the utility agent and orchestration canvas |
| Visual types | agent loop stepper, multi-agent handoff network, shared-state ledger, workflow-or-agent decision matrix |
...
| Professional work product | utility agent and orchestration canvas |
...
The **utility agent and orchestration canvas** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Agents, Agentic Nests, and Orchestration** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among workflow, agent, specialist, orchestrator, shared state, handoff, evaluation, retry, escalation, and stop?
...
7. What must be present in the **utility agent and orchestration canvas** before it is reviewable?
...
- Previous module reviewed: M40.
- Next module reviewed: M42.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: agent loop stepper.
- Ordered visual-shape sequence: feedback cycle, relationship, structured explanation, comparison and tradeoff.
