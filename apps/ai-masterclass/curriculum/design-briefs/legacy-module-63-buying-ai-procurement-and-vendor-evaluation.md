# Design Brief for M63: Buying AI: Procurement & Vendor Evaluation

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M63` |
...
| Evidence boundary | Blueprint direction only. Do not treat vendor claims as proof or allow procurement to bypass utility practice, security, privacy, legal, accessibility, records, finance, and public-accountability review. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A vendor demonstration solves a clean example, but the procurement record lacks source evidence, security review, data-use terms, total cost, service limits, acceptance tests, and exit rights. |
| What must the learner decide before teaching begins? | Recommend buy, build, partner, pilot, defer, or stop for one utility need and defend the contract controls. |
...
| What usable work product will the learner create? | AI procurement scorecard and decision record |
...
1. Explain Buying AI: Procurement & Vendor Evaluation in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish problem statement, requirement, demonstration, pilot, acceptance test, service level, data right, lock-in, total cost, and exit without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Do not treat vendor claims as proof or allow procurement to bypass utility practice, security, privacy, legal, accessibility, records, finance, and public-accountability review.
6. Create a usable AI procurement scorecard and decision record with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: problem statement, requirement, demonstration, pilot, acceptance test, service level, data right, lock-in, total cost, and exit | gated process | procurement phase gates | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | prediction and reveal |
| The module's consequential utility situation | status and measure | vendor evidence scorecard | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | multi-select |
| The learner decision, evidence, and human authority | comparison and tradeoff | total-cost and lock-in matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | scenario branching |
| The completed AI procurement scorecard and decision record | relationship | contract and exit responsibility map | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |

## Module design fingerprint

| Element | Selection |
| --- | --- |
| Narrative architecture | baseline to alternatives to cost and risk test to staged roadmap |
| Mental model | Utilities do not buy a pump from the photograph. They specify duty, materials, tests, warranty, service, records, and acceptance. AI purchasing deserves the same discipline. |
| Purposeful interaction 1 | tradeoff calculator, applied to: Recommend buy, build, partner, pilot, defer, or stop for one utility need and defend the contract controls. |
| Purposeful interaction 2 | roadmap builder, producing or reviewing the AI procurement scorecard and decision record |
| Visual types | procurement phase gates, vendor evidence scorecard, total-cost and lock-in matrix, contract and exit responsibility map |
...
| Professional work product | AI procurement scorecard and decision record |
...
The **AI procurement scorecard and decision record** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Buying AI: Procurement & Vendor Evaluation** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among problem statement, requirement, demonstration, pilot, acceptance test, service level, data right, lock-in, total cost, and exit?
...
7. What must be present in the **AI procurement scorecard and decision record** before it is reviewable?
...
- Previous module reviewed: M62.
- Next module reviewed: program close.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: procurement phase gates.
- Ordered visual-shape sequence: gated process, status and measure, comparison and tradeoff, relationship.
- Interaction pair: tradeoff calculator and roadmap builder.
