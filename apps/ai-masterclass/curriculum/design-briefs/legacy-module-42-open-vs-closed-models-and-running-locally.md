# Design Brief for M42: Open vs. Closed Models and Running Locally

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M42` |
...
| Evidence boundary | Blueprint direction only. Keep licenses, model versions, hardware needs, benchmarks, and provider terms dated. Local operation does not automatically create privacy or security. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A team assumes a local model solves privacy, then discovers that hardware, patching, evaluation, access, logging, and model provenance are now its responsibility. |
| What must the learner decide before teaching begins? | Choose a model deployment pattern for a bounded task and defend its data, cost, capability, maintenance, and exit tradeoffs. |
...
| What usable work product will the learner create? | model hosting and control decision record |
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: open weights, open source, proprietary model, hosted service, local inference, license, hardware, control, and support | comparison and tradeoff | open-closed comparison matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | true or false with correction |
| The module's consequential utility situation | layered structure | hosted-local responsibility stack | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | ordering |
| The learner decision, evidence, and human authority | structured explanation | hardware capability ladder | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | evidence classification |
| The completed model hosting and control decision record | range | control-cost tradeoff spectrum | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | Owning a generator gives control during an outage, but it also gives you fuel, maintenance, testing, and safety obligations. |
| Purposeful interaction 1 | provenance tracer, applied to: Choose a model deployment pattern for a bounded task and defend its data, cost, capability, maintenance, and exit tradeoffs. |
| Purposeful interaction 2 | stewardship-record builder, producing or reviewing the model hosting and control decision record |
| Visual types | open-closed comparison matrix, hosted-local responsibility stack, hardware capability ladder, control-cost tradeoff spectrum |
...
| Professional work product | model hosting and control decision record |
...
The **model hosting and control decision record** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Open vs. Closed Models and Running Locally** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among open weights, open source, proprietary model, hosted service, local inference, license, hardware, control, and support?
...
7. What must be present in the **model hosting and control decision record** before it is reviewable?
...
- Previous module reviewed: M41.
- Next module reviewed: M43.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: open-closed comparison matrix.
- Ordered visual-shape sequence: comparison and tradeoff, layered structure, structured explanation, range.
