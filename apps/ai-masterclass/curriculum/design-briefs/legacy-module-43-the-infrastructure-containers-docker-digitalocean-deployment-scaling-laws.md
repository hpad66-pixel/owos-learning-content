# Design Brief for M43: The Infrastructure: Containers, Docker, DigitalOcean, Deployment, Scaling Laws

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M43` |
| Curriculum part | Building AI Systems |
...
| Evidence boundary | Blueprint direction only. Keep vendor services, prices, limits, and scaling claims dated. Do not publish credentials or facility-sensitive architecture and do not skip security review. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A prototype works on one laptop, then fails in production because configuration, secrets, dependencies, traffic, logs, backups, updates, and ownership were never designed. |
| What must the learner decide before teaching begins? | Design the smallest supportable deployment architecture for a bounded utility application and name who operates every layer. |
...
| What usable work product will the learner create? | AI deployment and operations architecture record |
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: development, test, production, container, compute, storage, network, secret, deployment, scaling, observability, and recovery | layered structure | deployment architecture stack | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | prediction and reveal |
| The module's consequential utility situation | structured explanation | environment promotion pipeline | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | multi-select |
| The learner decision, evidence, and human authority | change over time | load and scaling curve | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | scenario branching |
| The completed AI deployment and operations architecture record | feedback cycle | operate-monitor-recover loop | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |

## Module design fingerprint

| Element | Selection |
| --- | --- |
| Narrative architecture | proposal review to architecture comparison to consequence test to decision record |
| Mental model | A pump is only one part of a pump station. Power, controls, housing, access, maintenance, alarms, and backup make it an operating system. |
| Purposeful interaction 1 | option comparator, applied to: Design the smallest supportable deployment architecture for a bounded utility application and name who operates every layer. |
| Purposeful interaction 2 | decision-record builder, producing or reviewing the AI deployment and operations architecture record |
| Visual types | deployment architecture stack, environment promotion pipeline, load and scaling curve, operate-monitor-recover loop |
...
| Quiz sequence | prediction and reveal, multi-select, scenario branching, final applied check |
...
| Professional work product | AI deployment and operations architecture record |
...
The **AI deployment and operations architecture record** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **The Infrastructure: Containers, Docker, DigitalOcean, Deployment, Scaling Laws** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among development, test, production, container, compute, storage, network, secret, deployment, scaling, observability, and recovery?
...
7. What must be present in the **AI deployment and operations architecture record** before it is reviewable?
...
- Previous module reviewed: M42.
- Next module reviewed: M44.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: deployment architecture stack.
- Ordered visual-shape sequence: layered structure, structured explanation, change over time, feedback cycle.
- Interaction pair: option comparator and decision-record builder.
