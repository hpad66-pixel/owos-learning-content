# Design Brief for M26: AI Security and Safety: Prompt Injection, OWASP LLM Top 10

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M26` |
...
| Evidence boundary | Blueprint direction only. Use safe test cases and current authoritative sources. Do not provide facility-specific exploitation instructions or treat a public risk list as law. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A retrieved document contains hidden instructions that tell the assistant to ignore policy and send sensitive results to an unapproved destination. |
| What must the learner decide before teaching begins? | Identify how an instruction or source could alter system behavior and choose prevention, detection, containment, or refusal controls. |
...
| What usable work product will the learner create? | AI attack and recovery test log |
...
1. Explain AI Security and Safety: Prompt Injection, OWASP LLM Top 10 in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish user instruction, system instruction, retrieved content, tool permission, untrusted output, attack, and control without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Use safe test cases and current authoritative sources. Do not provide facility-specific exploitation instructions or treat a public risk list as law.
6. Create a usable AI attack and recovery test log with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: user instruction, system instruction, retrieved content, tool permission, untrusted output, attack, and control | structured explanation | prompt injection path | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | true or false with correction |
| The module's consequential utility situation | structured explanation | trust-boundary diagram | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | ordering |
| The learner decision, evidence, and human authority | comparison and tradeoff | tool permission matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | evidence classification |
| The completed AI attack and recovery test log | feedback cycle | attack-detect-contain-recover loop | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A contaminated sample can enter a laboratory process looking legitimate. The chain needs controls before, during, and after analysis. |
| Purposeful interaction 1 | provenance tracer, applied to: Identify how an instruction or source could alter system behavior and choose prevention, detection, containment, or refusal controls. |
| Purposeful interaction 2 | stewardship-record builder, producing or reviewing the AI attack and recovery test log |
| Visual types | prompt injection path, trust-boundary diagram, tool permission matrix, attack-detect-contain-recover loop |
...
| Professional work product | AI attack and recovery test log |
...
The **AI attack and recovery test log** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **AI Security and Safety: Prompt Injection, OWASP LLM Top 10** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among user instruction, system instruction, retrieved content, tool permission, untrusted output, attack, and control?
...
7. What must be present in the **AI attack and recovery test log** before it is reviewable?
...
- Previous module reviewed: M25.
- Next module reviewed: M27.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: prompt injection path.
- Ordered visual-shape sequence: structured explanation, structured explanation, comparison and tradeoff, feedback cycle.
