# Design Brief for M13: Generative AI and RAG

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M13` |
...
| Evidence boundary | Blueprint direction only. A citation does not prove that the source is current, applicable, complete, or interpreted correctly. Keep the human review step visible. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | An employee asks for a permit requirement and receives a fluent answer that was not tied to the current permit, approved procedure, or governing source. |
| What must the learner decide before teaching begins? | Choose between unsupported generation, source-grounded retrieval, a fixed workflow, or no AI for a utility question. |
...
| What usable work product will the learner create? | retrieval-grounded answer contract |
...
1. Explain Generative AI and RAG in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish generation, retrieval, context, citation, source authority, and verified answer without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: A citation does not prove that the source is current, applicable, complete, or interpreted correctly. Keep the human review step visible.
6. Create a usable retrieval-grounded answer contract with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: generation, retrieval, context, citation, source authority, and verified answer | structured explanation | generation-versus-retrieval split | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | estimate and explain |
| The module's consequential utility situation | structured explanation | RAG answer pipeline | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | matching |
| The learner decision, evidence, and human authority | structured explanation | source authority ladder | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | decision multiple choice |
| The completed retrieval-grounded answer contract | relationship | citation coverage map | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A closed-book answer may sound fluent. An open-book answer can show its references. Neither is useful if the wrong book was selected. |
| Purposeful interaction 1 | consequence simulator, applied to: Choose between unsupported generation, source-grounded retrieval, a fixed workflow, or no AI for a utility question. |
| Purposeful interaction 2 | control-plan builder, producing or reviewing the retrieval-grounded answer contract |
| Visual types | generation-versus-retrieval split, RAG answer pipeline, source authority ladder, citation coverage map |
...
| Professional work product | retrieval-grounded answer contract |
...
The **retrieval-grounded answer contract** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Generative AI and RAG** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among generation, retrieval, context, citation, source authority, and verified answer?
...
7. What must be present in the **retrieval-grounded answer contract** before it is reviewable?
...
- Previous module reviewed: M12.
- Next module reviewed: M14.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: generation-versus-retrieval split.
- Ordered visual-shape sequence: structured explanation, structured explanation, structured explanation, relationship.
