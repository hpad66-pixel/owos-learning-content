# Design Brief for M53: The Capstone Studio

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M53` |
...
| Evidence boundary | Blueprint direction only. The studio does not authorize live operational change. Use approved or synthetic data and require owner, practitioner, technical, security, evidence, and release review. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A learner has a strong idea but must now connect the current process, evidence, users, controls, architecture, cost, test cases, stop conditions, and accountable decision. |
| What must the learner decide before teaching begins? | Defend whether the proposed pilot should proceed, be redesigned, wait for readiness work, or stop. |
...
| What usable work product will the learner create? | One Water AI governed pilot portfolio |
...
1. Explain The Capstone Studio in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish problem, baseline, hypothesis, pilot, production, evidence, control, measure, stop condition, and accountable next action without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: The studio does not authorize live operational change. Use approved or synthetic data and require owner, practitioner, technical, security, evidence, and release review.
6. Create a usable One Water AI governed pilot portfolio with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: problem, baseline, hypothesis, pilot, production, evidence, control, measure, stop condition, and accountable next action | relationship | pilot phase-gate roadmap | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | estimate and explain |
| The module's consequential utility situation | relationship | problem-to-evidence network | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | matching |
| The learner decision, evidence, and human authority | comparison and tradeoff | control and measurement matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | decision multiple choice |
| The completed One Water AI governed pilot portfolio | structured explanation | decision-room simulation | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A pilot brief is a flight plan, not a wish list. It names the destination, instruments, crew, fuel limit, alternate landing, and authority to stop. |
| Purposeful interaction 1 | consequence simulator, applied to: Defend whether the proposed pilot should proceed, be redesigned, wait for readiness work, or stop. |
| Purposeful interaction 2 | control-plan builder, producing or reviewing the One Water AI governed pilot portfolio |
| Visual types | pilot phase-gate roadmap, problem-to-evidence network, control and measurement matrix, decision-room simulation |
...
| Professional work product | One Water AI governed pilot portfolio |
...
The **One Water AI governed pilot portfolio** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **The Capstone Studio** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among problem, baseline, hypothesis, pilot, production, evidence, control, measure, stop condition, and accountable next action?
...
7. What must be present in the **One Water AI governed pilot portfolio** before it is reviewable?
...
- Previous module reviewed: M52.
- Next module reviewed: M54.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: pilot phase-gate roadmap.
- Ordered visual-shape sequence: relationship, relationship, comparison and tradeoff, structured explanation.
