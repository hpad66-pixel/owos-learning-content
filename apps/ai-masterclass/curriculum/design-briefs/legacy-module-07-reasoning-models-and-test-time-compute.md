# Design Brief for M07: Reasoning Models and Test-Time Compute

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M07` |
...
| Evidence boundary | Blueprint direction only. Do not treat chain-of-thought text, answer length, benchmark claims, or compute use as proof of correctness or professional authority. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A team uses the most expensive reasoning mode for simple summaries and then trusts a long answer on a capital decision because it appears more thoughtful. |
| What must the learner decide before teaching begins? | Select an appropriate answer mode and review path for a routine, analytical, or consequential utility task. |
...
| What usable work product will the learner create? | task-to-reasoning selection card |
...
1. Explain Reasoning Models and Test-Time Compute in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish ordinary inference, test-time computation, tool-supported analysis, visible explanation, hidden reasoning, and evidence without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: Do not treat chain-of-thought text, answer length, benchmark claims, or compute use as proof of correctness or professional authority.
6. Create a usable task-to-reasoning selection card with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: ordinary inference, test-time computation, tool-supported analysis, visible explanation, hidden reasoning, and evidence | comparison and tradeoff | task consequence matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | prediction and reveal |
| The module's consequential utility situation | change over time | time-cost-quality curve | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | multi-select |
| The learner decision, evidence, and human authority | branching decision | reasoning mode decision tree | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | scenario branching |
| The completed task-to-reasoning selection card | structured explanation | review depth ladder | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | You do not convene a design review to read a meter, and you do not approve a major change from a quick glance. The amount of effort should fit the decision. |
| Purposeful interaction 1 | tradeoff calculator, applied to: Select an appropriate answer mode and review path for a routine, analytical, or consequential utility task. |
| Purposeful interaction 2 | roadmap builder, producing or reviewing the task-to-reasoning selection card |
| Visual types | task consequence matrix, time-cost-quality curve, reasoning mode decision tree, review depth ladder |
...
| Professional work product | task-to-reasoning selection card |
...
The **task-to-reasoning selection card** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Reasoning Models and Test-Time Compute** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among ordinary inference, test-time computation, tool-supported analysis, visible explanation, hidden reasoning, and evidence?
...
7. What must be present in the **task-to-reasoning selection card** before it is reviewable?
...
- Previous module reviewed: M06.
- Next module reviewed: M08.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: task consequence matrix.
- Ordered visual-shape sequence: comparison and tradeoff, change over time, branching decision, structured explanation.
