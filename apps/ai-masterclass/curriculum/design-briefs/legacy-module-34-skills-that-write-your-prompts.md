# Design Brief for M34: Skills That Write Your Prompts

## Identity

| Field | Decision |
| --- | --- |
| Course and module ID | `one-water-ai-applied-intelligence / legacy:M34` |
...
| Evidence boundary | Blueprint direction only. A reusable instruction package does not approve its own facts, permissions, methods, or release. Keep platform-specific packaging dated. |

## Learning job

| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A senior analyst performs the same careful review every month, but each coworker rebuilds the prompt from memory and loses one control. |
| What must the learner decide before teaching begins? | Determine whether a repeatable utility task should become a reusable skill and define how it will be tested and maintained. |
...
| What usable work product will the learner create? | versioned utility skill specification |
...
1. Explain Skills That Write Your Prompts in plain English and connect it to a real water, wastewater, stormwater, or One Water decision.
2. Distinguish one-time prompt, template, skill, workflow, script, asset, trigger, test, version, and owner without using one term to hide several different jobs.
...
5. Evaluate sources, assumptions, limitations, permissions, and human authority using this boundary: A reusable instruction package does not approve its own facts, permissions, methods, or release. Keep platform-specific packaging dated.
6. Create a usable versioned utility skill specification with evidence, roles, limits, review steps, and the next accountable action.
...
| --- | --- | --- | --- | --- | --- |
| Core distinctions: one-time prompt, template, skill, workflow, script, asset, trigger, test, version, and owner | structured explanation | skill package anatomy | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | true or false with correction |
| The module's consequential utility situation | process and handoff | trigger-to-result workflow | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | ordering |
| The learner decision, evidence, and human authority | change over time | version and test timeline | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | evidence classification |
| The completed versioned utility skill specification | comparison and tradeoff | skill-or-workflow decision matrix | inspect, compare, decide, or build | evidence, consequence, or relationship becomes visible | final applied check |
...
| Mental model | A trusted recipe names ingredients, steps, equipment, checks, and the result. A skill should make a professional method equally repeatable. |
| Purposeful interaction 1 | provenance tracer, applied to: Determine whether a repeatable utility task should become a reusable skill and define how it will be tested and maintained. |
| Purposeful interaction 2 | stewardship-record builder, producing or reviewing the versioned utility skill specification |
| Visual types | skill package anatomy, trigger-to-result workflow, version and test timeline, skill-or-workflow decision matrix |
...
| Professional work product | versioned utility skill specification |
...
The **versioned utility skill specification** must record the problem, user, decision, approved evidence, assumptions,
...
1. What does **Skills That Write Your Prompts** mean in ordinary utility language?
2. Where can this help in drinking water, wastewater, stormwater, or cross-functional work?
3. What is the difference among one-time prompt, template, skill, workflow, script, asset, trigger, test, version, and owner?
...
7. What must be present in the **versioned utility skill specification** before it is reviewable?
...
- Previous module reviewed: M33.
- Next module reviewed: M35.
- Opening pattern: begins with the module-specific situation, not a repeated definition panel.
- Dominant visual: skill package anatomy.
- Ordered visual-shape sequence: structured explanation, process and handoff, change over time, comparison and tradeoff.
