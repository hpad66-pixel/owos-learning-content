# Research and production prompt for BB05

You are developing **Testing, Dependencies, and Environments** for the One Water AI Builder Bridge. Work as a curriculum
...
> Prove that a change works under known conditions, fails visibly under wrong conditions, and can be reproduced outside the builder's laptop.

The required applied result is **test, dependency, and environment evidence package**.

## Non-negotiable objectives

1. Distinguish unit, integration, regression, security, accessibility, and acceptance tests.
2. Identify code, package, version, configuration, secret, operating system, and service dependencies.
3. Create and use an isolated environment with recorded dependency versions.
4. Design tests for ordinary, boundary, malformed, unauthorized, and failure cases.
5. Create a test, dependency, and environment evidence package.
