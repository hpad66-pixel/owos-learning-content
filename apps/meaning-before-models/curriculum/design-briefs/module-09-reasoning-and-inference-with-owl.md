# OWOS Module Design Brief: Reasoning and Inference with OWL
...
| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | The graph states that Pump P-104 serves Zone 3 and that Zone 3 is part of the North Service Area. A new relationship appears after reasoning. |
| What must the learner decide before teaching begins? | What must accompany an inferred statement? |
...
| What should the learner be able to do afterward? | Web Ontology Language reasoning derives statements under declared logic. It does not predict the future or replace human judgment. |
| What usable work product will the learner create? | Inference Boundary Card |
...
| Element | Selection |
| --- | --- |
| Narrative architecture | The graph states that Pump P-104 serves Zone 3 and that Zone 3 is part of the North Service Area. A new relationship appears after reasoning. |
...
| Professional work product | Inference Boundary Card |
...
| --- | --- | --- | --- | --- | --- |
| How does OWL apply? | New term | It performs one named job in the module mental model. | The graph states that Pump P-104 serves Zone 3 and that Zone 3 is part of the North Service Area. A new relationship appears after reasoning. | Selected module visuals | Instructional scenario |
| How does assertion apply? | New term | It performs one named job in the module mental model. | The graph states that Pump P-104 serves Zone 3 and that Zone 3 is part of the North Service Area. A new relationship appears after reasoning. | Selected module visuals | Instructional scenario |
| How does axiom apply? | New term | It performs one named job in the module mental model. | The graph states that Pump P-104 serves Zone 3 and that Zone 3 is part of the North Service Area. A new relationship appears after reasoning. | Selected module visuals | Instructional scenario |
| How does inference apply? | New term | It performs one named job in the module mental model. | The graph states that Pump P-104 serves Zone 3 and that Zone 3 is part of the North Service Area. A new relationship appears after reasoning. | Selected module visuals | Instructional scenario |
| How does entailment apply? | New term | It performs one named job in the module mental model. | The graph states that Pump P-104 serves Zone 3 and that Zone 3 is part of the North Service Area. A new relationship appears after reasoning. | Selected module visuals | Instructional scenario |
...
| Spoken opening | The graph states that Pump P-104 serves Zone 3 and that Zone 3 is part of the North Service Area. A new relationship appears after reasoning. |
| Utility example | Module scenario and work product |
| Visual directions | Follow the four selected visual patterns |
| Learner action and work product | Complete Inference Boundary Card |
...
- Work-product format intentionally different: Inference Boundary Card.
