# OWOS Module Design Brief: Design the One Water Knowledge Spine

## Identity
| Field | Decision |
| --- | --- |
| Course and module ID | `owos-course-semantic-data-ai-001`, `mbm001:18` |
| Working title | Design the One Water Knowledge Spine |
...
| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A team proposes an enterprise knowledge graph before naming one operational question, one decision owner, or one measurable outcome. |
| What must the learner decide before teaching begins? | What should the pilot define first? |
...
| What should the learner be able to do afterward? | A useful pilot connects graph fit, identity, relationships, evidence, mappings, validation, context, access, agent controls, ownership, and measures around one decision. |
| What usable work product will the learner create? | One Water Knowledge Spine Pilot Canvas |
...
| Element | Selection |
| --- | --- |
| Narrative architecture | A team proposes an enterprise knowledge graph before naming one operational question, one decision owner, or one measurable outcome. |
...
| Professional work product | One Water Knowledge Spine Pilot Canvas |
...
| --- | --- | --- | --- | --- | --- |
| How does Graph Fit Test apply? | New term | It performs one named job in the module mental model. | A team proposes an enterprise knowledge graph before naming one operational question, one decision owner, or one measurable outcome. | Selected module visuals | Instructional scenario |
| How does pilot apply? | New term | It performs one named job in the module mental model. | A team proposes an enterprise knowledge graph before naming one operational question, one decision owner, or one measurable outcome. | Selected module visuals | Instructional scenario |
| How does operational question apply? | New term | It performs one named job in the module mental model. | A team proposes an enterprise knowledge graph before naming one operational question, one decision owner, or one measurable outcome. | Selected module visuals | Instructional scenario |
| How does competency apply? | New term | It performs one named job in the module mental model. | A team proposes an enterprise knowledge graph before naming one operational question, one decision owner, or one measurable outcome. | Selected module visuals | Instructional scenario |
| How does baseline apply? | New term | It performs one named job in the module mental model. | A team proposes an enterprise knowledge graph before naming one operational question, one decision owner, or one measurable outcome. | Selected module visuals | Instructional scenario |

## Recording script
| Field | Decision |
| --- | --- |
| Script path | `curriculum/scripts/module-18-design-the-one-water-knowledge-spine-video-script.md` |
| Intended recording length | 25 to 35 minutes |
| Spoken opening | A team proposes an enterprise knowledge graph before naming one operational question, one decision owner, or one measurable outcome. |
| Utility example | Module scenario and work product |
| Visual directions | Follow the four selected visual patterns |
| Learner action and work product | Complete One Water Knowledge Spine Pilot Canvas |
...
- Work-product format intentionally different: One Water Knowledge Spine Pilot Canvas.
