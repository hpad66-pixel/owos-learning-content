...
| Field | Decision |
| --- | --- |
| Course and module ID | `owos-course-semantic-data-ai-001`, `mbm001:07` |
| Working title | Ontology Engineering in Plain Language |
...
| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A modeling workshop starts with forty nouns and no agreement about the operational question the model must answer. |
| What must the learner decide before teaching begins? | What should the team write before adding more concepts? |
...
| What should the learner be able to do afterward? | Ontology engineering is a controlled sequence from useful questions to shared concepts, relationships, tests, ownership, and versioned release. |
| What usable work product will the learner create? | Ontology Decision Record |
...
| Element | Selection |
| --- | --- |
| Narrative architecture | A modeling workshop starts with forty nouns and no agreement about the operational question the model must answer. |
...
| Professional work product | Ontology Decision Record |
...
| --- | --- | --- | --- | --- | --- |
| How does competency question apply? | New term | It performs one named job in the module mental model. | A modeling workshop starts with forty nouns and no agreement about the operational question the model must answer. | Selected module visuals | Instructional scenario |
| How does ontology apply? | New term | It performs one named job in the module mental model. | A modeling workshop starts with forty nouns and no agreement about the operational question the model must answer. | Selected module visuals | Instructional scenario |
| How does upper ontology apply? | New term | It performs one named job in the module mental model. | A modeling workshop starts with forty nouns and no agreement about the operational question the model must answer. | Selected module visuals | Instructional scenario |
| How does domain ontology apply? | New term | It performs one named job in the module mental model. | A modeling workshop starts with forty nouns and no agreement about the operational question the model must answer. | Selected module visuals | Instructional scenario |
| How does application profile apply? | New term | It performs one named job in the module mental model. | A modeling workshop starts with forty nouns and no agreement about the operational question the model must answer. | Selected module visuals | Instructional scenario |

## Recording script
| Field | Decision |
| --- | --- |
| Script path | `curriculum/scripts/module-07-ontology-engineering-in-plain-language-video-script.md` |
| Intended recording length | 25 to 35 minutes |
| Spoken opening | A modeling workshop starts with forty nouns and no agreement about the operational question the model must answer. |
| Utility example | Module scenario and work product |
| Visual directions | Follow the four selected visual patterns |
| Learner action and work product | Complete Ontology Decision Record |
...
- Work-product format intentionally different: Ontology Decision Record.
