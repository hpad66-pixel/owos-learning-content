# OWOS Module Design Brief: Structured and Unstructured Knowledge

## Identity
| Field | Decision |
| --- | --- |
| Course and module ID | `owos-course-semantic-data-ai-001`, `mbm001:15` |
| Working title | Structured and Unstructured Knowledge |
...
| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | An overflow response depends on sensor records, a map, an email, a call transcript, a procedure, inspection photographs, and a permit clause. |
| What must the learner decide before teaching begins? | Does an embedding turn every retrieved passage into approved knowledge? |
...
| What should the learner be able to do afterward? | Structured and unstructured evidence become useful through different combinations of metadata, search, embeddings, extraction, explicit relationships, and approval. |
| What usable work product will the learner create? | Structured-Unstructured Evidence Plan |
...
| Element | Selection |
| --- | --- |
| Narrative architecture | An overflow response depends on sensor records, a map, an email, a call transcript, a procedure, inspection photographs, and a permit clause. |
...
| Professional work product | Structured-Unstructured Evidence Plan |
...
| --- | --- | --- | --- | --- | --- |
| How does structured data apply? | New term | It performs one named job in the module mental model. | An overflow response depends on sensor records, a map, an email, a call transcript, a procedure, inspection photographs, and a permit clause. | Selected module visuals | Instructional scenario |
| How does unstructured data apply? | New term | It performs one named job in the module mental model. | An overflow response depends on sensor records, a map, an email, a call transcript, a procedure, inspection photographs, and a permit clause. | Selected module visuals | Instructional scenario |
| How does metadata apply? | New term | It performs one named job in the module mental model. | An overflow response depends on sensor records, a map, an email, a call transcript, a procedure, inspection photographs, and a permit clause. | Selected module visuals | Instructional scenario |
| How does embedding apply? | New term | It performs one named job in the module mental model. | An overflow response depends on sensor records, a map, an email, a call transcript, a procedure, inspection photographs, and a permit clause. | Selected module visuals | Instructional scenario |
| How does vector search apply? | New term | It performs one named job in the module mental model. | An overflow response depends on sensor records, a map, an email, a call transcript, a procedure, inspection photographs, and a permit clause. | Selected module visuals | Instructional scenario |

## Recording script
| Field | Decision |
| --- | --- |
| Script path | `curriculum/scripts/module-15-structured-and-unstructured-knowledge-video-script.md` |
| Intended recording length | 25 to 35 minutes |
| Spoken opening | An overflow response depends on sensor records, a map, an email, a call transcript, a procedure, inspection photographs, and a permit clause. |
| Utility example | Module scenario and work product |
| Visual directions | Follow the four selected visual patterns |
| Learner action and work product | Complete Structured-Unstructured Evidence Plan |
...
- Work-product format intentionally different: Structured-Unstructured Evidence Plan.
