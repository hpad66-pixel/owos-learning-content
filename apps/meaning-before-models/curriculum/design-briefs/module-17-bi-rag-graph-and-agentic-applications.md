# OWOS Module Design Brief: BI, RAG, Graph Grounding, and Agentic Applications

## Identity
| Field | Decision |
| --- | --- |
| Course and module ID | `owos-course-semantic-data-ai-001`, `mbm001:17` |
| Working title | BI, RAG, Graph Grounding, and Agentic Applications |
...
| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | The same Pump P-104 question is sent through joined tables, a dashboard, document retrieval, an RDF graph, and an agent with tools. |
| What must the learner decide before teaching begins? | Which technology label tells you the whole answer path is deterministic? |
...
| What should the learner be able to do afterward? | Compare complete pipelines stage by stage, then separate knowing, proposing, authorizing, acting, stopping, and recording. |
| What usable work product will the learner create? | Repeatability Map and Agent Action Contract |
...
| Element | Selection |
| --- | --- |
| Narrative architecture | The same Pump P-104 question is sent through joined tables, a dashboard, document retrieval, an RDF graph, and an agent with tools. |
...
| Professional work product | Repeatability Map and Agent Action Contract |
...
| --- | --- | --- | --- | --- | --- |
| How does BI apply? | New term | It performs one named job in the module mental model. | The same Pump P-104 question is sent through joined tables, a dashboard, document retrieval, an RDF graph, and an agent with tools. | Selected module visuals | Instructional scenario |
| How does RAG apply? | New term | It performs one named job in the module mental model. | The same Pump P-104 question is sent through joined tables, a dashboard, document retrieval, an RDF graph, and an agent with tools. | Selected module visuals | Instructional scenario |
| How does graph grounding apply? | New term | It performs one named job in the module mental model. | The same Pump P-104 question is sent through joined tables, a dashboard, document retrieval, an RDF graph, and an agent with tools. | Selected module visuals | Instructional scenario |
| How does agent apply? | New term | It performs one named job in the module mental model. | The same Pump P-104 question is sent through joined tables, a dashboard, document retrieval, an RDF graph, and an agent with tools. | Selected module visuals | Instructional scenario |
| How does retrieval apply? | New term | It performs one named job in the module mental model. | The same Pump P-104 question is sent through joined tables, a dashboard, document retrieval, an RDF graph, and an agent with tools. | Selected module visuals | Instructional scenario |

## Recording script
| Field | Decision |
| --- | --- |
| Script path | `curriculum/scripts/module-17-bi-rag-graph-and-agentic-applications-video-script.md` |
| Intended recording length | 25 to 35 minutes |
| Spoken opening | The same Pump P-104 question is sent through joined tables, a dashboard, document retrieval, an RDF graph, and an agent with tools. |
| Utility example | Module scenario and work product |
| Visual directions | Follow the four selected visual patterns |
| Learner action and work product | Complete Repeatability Map and Agent Action Contract |
...
- Work-product format intentionally different: Repeatability Map and Agent Action Contract.
