...
| Field | Decision |
| --- | --- |
| Course and module ID | `owos-course-semantic-data-ai-001`, `mbm001:01` |
| Working title | RDF in 15 Minutes |
...
| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A pump alarm appears at 2:00 a.m. The records name a pump, a pressure zone, a work order, and customers, but no record states the complete path. |
| What must the learner decide before teaching begins? | Which statement gives a machine one reusable piece of meaning? |
...
| What should the learner be able to do afterward? | Resource Description Framework starts with one directed, named relationship: subject, predicate, object. |
| What usable work product will the learner create? | Relationship Card |
...
| Element | Selection |
| --- | --- |
| Narrative architecture | A pump alarm appears at 2:00 a.m. The records name a pump, a pressure zone, a work order, and customers, but no record states the complete path. |
...
| Professional work product | Relationship Card |
...
| --- | --- | --- | --- | --- | --- |
| How does RDF apply? | New term | It performs one named job in the module mental model. | A pump alarm appears at 2:00 a.m. The records name a pump, a pressure zone, a work order, and customers, but no record states the complete path. | Selected module visuals | Instructional scenario |
| How does triple apply? | New term | It performs one named job in the module mental model. | A pump alarm appears at 2:00 a.m. The records name a pump, a pressure zone, a work order, and customers, but no record states the complete path. | Selected module visuals | Instructional scenario |
| How does subject apply? | New term | It performs one named job in the module mental model. | A pump alarm appears at 2:00 a.m. The records name a pump, a pressure zone, a work order, and customers, but no record states the complete path. | Selected module visuals | Instructional scenario |
| How does predicate apply? | New term | It performs one named job in the module mental model. | A pump alarm appears at 2:00 a.m. The records name a pump, a pressure zone, a work order, and customers, but no record states the complete path. | Selected module visuals | Instructional scenario |
| How does object apply? | New term | It performs one named job in the module mental model. | A pump alarm appears at 2:00 a.m. The records name a pump, a pressure zone, a work order, and customers, but no record states the complete path. | Selected module visuals | Instructional scenario |

## Recording script
| Field | Decision |
| --- | --- |
| Script path | `curriculum/scripts/module-01-rdf-in-15-minutes-video-script.md` |
| Intended recording length | 25 to 35 minutes |
| Spoken opening | A pump alarm appears at 2:00 a.m. The records name a pump, a pressure zone, a work order, and customers, but no record states the complete path. |
| Utility example | Module scenario and work product |
| Visual directions | Follow the four selected visual patterns |
| Learner action and work product | Complete Relationship Card |
...
- Work-product format intentionally different: Relationship Card.
