# OWOS Module Design Brief: Context Engines and Runtime AI Context

## Identity
| Field | Decision |
| --- | --- |
| Course and module ID | `owos-course-semantic-data-ai-001`, `mbm001:16` |
| Working title | Context Engines and Runtime AI Context |
...
| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | An agent receives the right customer and wrong procedure because the task package omitted effective time, jurisdiction, permission, and workflow state. |
| What must the learner decide before teaching begins? | Is the context engine the same thing as the context it supplies? |
...
| What should the learner be able to do afterward? | Runtime AI context is a bounded package of intent, entities, evidence, definitions, policy, time, permissions, state, conflicts, tools, and output limits. |
| What usable work product will the learner create? | AI Context Contract |
...
| Element | Selection |
| --- | --- |
| Narrative architecture | An agent receives the right customer and wrong procedure because the task package omitted effective time, jurisdiction, permission, and workflow state. |
...
| Professional work product | AI Context Contract |
...
| --- | --- | --- | --- | --- | --- |
| How does context engine apply? | New term | It performs one named job in the module mental model. | An agent receives the right customer and wrong procedure because the task package omitted effective time, jurisdiction, permission, and workflow state. | Selected module visuals | Instructional scenario |
| How does AI context apply? | New term | It performs one named job in the module mental model. | An agent receives the right customer and wrong procedure because the task package omitted effective time, jurisdiction, permission, and workflow state. | Selected module visuals | Instructional scenario |
| How does user intent apply? | New term | It performs one named job in the module mental model. | An agent receives the right customer and wrong procedure because the task package omitted effective time, jurisdiction, permission, and workflow state. | Selected module visuals | Instructional scenario |
| How does runtime state apply? | New term | It performs one named job in the module mental model. | An agent receives the right customer and wrong procedure because the task package omitted effective time, jurisdiction, permission, and workflow state. | Selected module visuals | Instructional scenario |
| How does jurisdiction apply? | New term | It performs one named job in the module mental model. | An agent receives the right customer and wrong procedure because the task package omitted effective time, jurisdiction, permission, and workflow state. | Selected module visuals | Instructional scenario |

## Recording script
| Field | Decision |
| --- | --- |
| Script path | `curriculum/scripts/module-16-context-engines-and-runtime-ai-context-video-script.md` |
| Intended recording length | 25 to 35 minutes |
| Spoken opening | An agent receives the right customer and wrong procedure because the task package omitted effective time, jurisdiction, permission, and workflow state. |
| Utility example | Module scenario and work product |
| Visual directions | Follow the four selected visual patterns |
| Learner action and work product | Complete AI Context Contract |
...
- Work-product format intentionally different: AI Context Contract.
