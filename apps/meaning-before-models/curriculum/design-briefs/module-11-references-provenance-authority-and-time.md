# OWOS Module Design Brief: References, Provenance, Authority, and Time
...
| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | A current sensor reading, an old procedure, a staff note, an extracted clause, and an approved engineering rule all make claims about Pump P-104. |
| What must the learner decide before teaching begins? | Which statement should control an operational recommendation? |
...
| What should the learner be able to do afterward? | Source, authority, time, version, and supersession are separate controls that let conflicting statements be preserved and resolved. |
| What usable work product will the learner create? | Authority, Provenance, and Time Ledger |
...
| Element | Selection |
| --- | --- |
| Narrative architecture | A current sensor reading, an old procedure, a staff note, an extracted clause, and an approved engineering rule all make claims about Pump P-104. |
...
| Professional work product | Authority, Provenance, and Time Ledger |
...
| --- | --- | --- | --- | --- | --- |
| How does provenance apply? | New term | It performs one named job in the module mental model. | A current sensor reading, an old procedure, a staff note, an extracted clause, and an approved engineering rule all make claims about Pump P-104. | Selected module visuals | Instructional scenario |
| How does authority apply? | New term | It performs one named job in the module mental model. | A current sensor reading, an old procedure, a staff note, an extracted clause, and an approved engineering rule all make claims about Pump P-104. | Selected module visuals | Instructional scenario |
| How does observation time apply? | New term | It performs one named job in the module mental model. | A current sensor reading, an old procedure, a staff note, an extracted clause, and an approved engineering rule all make claims about Pump P-104. | Selected module visuals | Instructional scenario |
| How does record time apply? | New term | It performs one named job in the module mental model. | A current sensor reading, an old procedure, a staff note, an extracted clause, and an approved engineering rule all make claims about Pump P-104. | Selected module visuals | Instructional scenario |
| How does effective time apply? | New term | It performs one named job in the module mental model. | A current sensor reading, an old procedure, a staff note, an extracted clause, and an approved engineering rule all make claims about Pump P-104. | Selected module visuals | Instructional scenario |
...
| Spoken opening | A current sensor reading, an old procedure, a staff note, an extracted clause, and an approved engineering rule all make claims about Pump P-104. |
| Utility example | Module scenario and work product |
| Visual directions | Follow the four selected visual patterns |
| Learner action and work product | Complete Authority, Provenance, and Time Ledger |
...
- Work-product format intentionally different: Authority, Provenance, and Time Ledger.
