...
| Field | Decision |
| --- | --- |
| Course and module ID | `owos-course-semantic-data-ai-001`, `mbm001:06` |
| Working title | Taxonomies, Vocabularies, and RDFS |
...
| Question | Answer |
| --- | --- |
| What consequential situation opens the lesson? | Four utility teams use the word asset for equipment, facilities, pipes, documents, and financial records. |
| What must the learner decide before teaching begins? | What should the team establish before connecting all five uses? |
...
| What should the learner be able to do afterward? | A taxonomy classifies terms. RDF Schema adds reusable classes, properties, labels, domains, ranges, and hierarchies. |
| What usable work product will the learner create? | Vocabulary and Taxonomy Sheet |
...
| Element | Selection |
| --- | --- |
| Narrative architecture | Four utility teams use the word asset for equipment, facilities, pipes, documents, and financial records. |
...
| Professional work product | Vocabulary and Taxonomy Sheet |
...
| --- | --- | --- | --- | --- | --- |
| How does vocabulary apply? | New term | It performs one named job in the module mental model. | Four utility teams use the word asset for equipment, facilities, pipes, documents, and financial records. | Selected module visuals | Instructional scenario |
| How does taxonomy apply? | New term | It performs one named job in the module mental model. | Four utility teams use the word asset for equipment, facilities, pipes, documents, and financial records. | Selected module visuals | Instructional scenario |
| How does class apply? | New term | It performs one named job in the module mental model. | Four utility teams use the word asset for equipment, facilities, pipes, documents, and financial records. | Selected module visuals | Instructional scenario |
| How does instance apply? | New term | It performs one named job in the module mental model. | Four utility teams use the word asset for equipment, facilities, pipes, documents, and financial records. | Selected module visuals | Instructional scenario |
| How does property apply? | New term | It performs one named job in the module mental model. | Four utility teams use the word asset for equipment, facilities, pipes, documents, and financial records. | Selected module visuals | Instructional scenario |

## Recording script
| Field | Decision |
| --- | --- |
| Script path | `curriculum/scripts/module-06-taxonomies-vocabularies-and-rdfs-video-script.md` |
| Intended recording length | 25 to 35 minutes |
| Spoken opening | Four utility teams use the word asset for equipment, facilities, pipes, documents, and financial records. |
| Utility example | Module scenario and work product |
| Visual directions | Follow the four selected visual patterns |
| Learner action and work product | Complete Vocabulary and Taxonomy Sheet |
...
- Work-product format intentionally different: Vocabulary and Taxonomy Sheet.
