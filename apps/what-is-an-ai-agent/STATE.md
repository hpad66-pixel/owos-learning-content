...
- Assigned stable course ID `owos-course-ai-agents-001` and slug `what-is-an-ai-agent`.
...
- `research/originals/what-is-an-ai-agent.pdf`, private research, permission pending.
