...
Platform routes (community, graph, sponsorship) resolve inside OWOS and would
404 standalone, so the published build says so rather than shipping dead links.
"""
